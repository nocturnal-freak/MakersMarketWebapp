						...
						<div className="row">
							<div className="col-lg-4">
								<div className="testimonial-item mx-auto mb-5 mb-lg-0">
									<img className="img-fluid rounded-circle mb-3" src="" alt="" />
									<h5>Vijay</h5>
									<p className="font-weight-light mb-0">"Head-US and Branch at hyderabad makersmarket, is a new age corporate with primary morale focuses on customer satisfaction, with divine dedication and determination on every business transaction, we bestow to deliver innovative and quality solutions valued by every solitary customer associated with us.
!"</p>
								</div>
							</div>
							<div className="col-lg-4">
								<div className="testimonial-item mx-auto mb-5 mb-lg-0">
									<img className="img-fluid rounded-circle mb-3" src="" alt="" />
									<h5>Anusha.</h5>
									<p className="font-weight-light mb-0">"To serve the best with the best of novel solutions based on your business model, we ignite fresh minds to spark up fresh thoughts, heaping up the finest ideas aiming to acme your niche among your competitors."</p>
								</div>
							</div>
							<div className="col-lg-4">
								<div className="testimonial-item mx-auto mb-5 mb-lg-0">
									<img className="img-fluid rounded-circle mb-3" src="" alt="" />
									<h5>Shiva.</h5>
									<p className="font-weight-light mb-0">"Believing in technology and the mode it manipulate one’s life, we are a devoted bunch of business professionals with expertise in B2B trainings and dexterous in marketing & communications solutions.!"</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="container">
						<div className="row">
							<div className="col-xl-9 mx-auto">
								<h2 style={Styles.contact} className="mb-4">Wanna get touch with us? Drop your email now!</h2>

							</div>
							<div className="col-md-10 col-lg-8 col-xl-7 mx-auto">
								<h2 style={Styles.contact} className="mb-4">VENDOR / SPONSOR</h2>

										<div className="col-12" style={{'margin-bottom':'2px'}}>
										...
										<div className="col-12">
											<button className="rounder btn btn-block btn-lg btn-primary" type="submit" onClick={this.sendMail}>Send!</button>
										</div>
